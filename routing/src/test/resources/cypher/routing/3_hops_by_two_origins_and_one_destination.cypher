...
CREATE (o1:Hop {origin: true, name:'o1', uid: 'o1'})
...
CREATE (p2)-[:HOPS_OFF]->(d1)
CREATE (o2)-[:BOOKED_TO]->(d1)


CREATE (v1)-[:DISTANCE {weight: 10}]->(o1)
CREATE (v1)-[:DISTANCE {weight: 15}]->(o2)

CREATE (o1)-[:DISTANCE {weight: 10}]->(o2)
CREATE (o2)-[:DISTANCE {weight: 10}]->(o1)

MERGE (o1)-[:DISTANCE {weight: 10}]-(d1)
MERGE (o2)-[:DISTANCE {weight: 20}]-(d1);
